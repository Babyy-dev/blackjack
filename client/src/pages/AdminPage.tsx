    ...
    <div className="min-h-screen w-full bg-[#050f15] text-white">
      ...
      <main className="mx-auto max-w-[1600px] px-6 py-12">
        <header className="mb-12">
          ...
          >
            <h1 className="font-display text-4xl font-bold uppercase tracking-widest text-white drop-shadow-lg sm:text-5xl">
              <span className="text-amber-400">Admin</span> Console
            </h1>
            <p className="mt-2 text-sm font-bold uppercase tracking-[0.2rem] text-white/40">
          ...
          {actionError && (
            <motion.div
              ...
              className="mt-6 rounded-xl border border-red-500/20 bg-red-500/10 px-6 py-4 text-sm font-bold text-red-400"
            >
              {actionError}
            </motion.div>
          )}
        ...
        <div className="grid gap-8 lg:grid-cols-[280px_1fr]">
          <aside className="h-fit rounded-3xl border border-white/10 bg-black/20 p-6 backdrop-blur-md lg:sticky lg:top-24">
            <p className="mb-6 text-xs font-bold uppercase tracking-[0.25rem] text-amber-500">
              Navigation
            </p>
            <nav className="space-y-2">
              {sections.map((section) => (
                <a
                  key={section.id}
                  href={`#${section.id}`}
                  className="group block rounded-xl border border-transparent bg-white/5 px-4 py-3 transition-all hover:border-amber-400/30 hover:bg-amber-400/10"
                >
                  <span className="block text-sm font-bold text-white group-hover:text-amber-100">
                    {section.label}
                  </span>
                  <span className="mt-1 block text-[0.65rem] uppercase tracking-wider text-white/40 group-hover:text-white/60">
                    {section.helper}
                  </span>
                </a>
              ))}
          ...
          <div className="space-y-12">
            <section id="overview" className="rounded-3xl border border-white/10 bg-black/20 p-8 backdrop-blur-md">
              <div className="mb-8 flex items-center justify-between">
                <h2 className="text-xl font-display font-bold uppercase tracking-widest text-white sm:text-2xl">
              ...
              <div className="mt-6 grid gap-6 md:grid-cols-4">
                {[
                  ...
                  <div
                    key={card.label}
                    className="rounded-2xl border border-white/10 bg-white/5 p-6 text-center transition-transform hover:scale-105"
                  >
                    <p className="text-[0.65rem] font-bold uppercase tracking-widest text-white/40">
                      {card.label}
                    </p>
                    <p className="mt-2 text-3xl font-display font-bold text-white sm:text-4xl text-amber-400">
                      {card.value}
                    </p>
                  </div>
                ))}
                ...
                <div className="space-y-3">
                  ...
                  {tables.map((table) => (
                    <button
                      ...
                      className={`w-full rounded-2xl border px-4 py-3 text-left text-xs uppercase tracking-[0.2rem] transition ${selectedTableId === table.id
